...
public class SellerController {
    ...
    public String updateAddress(@RequestBody Map<String, Object> map, HttpServletRequest httpServletRequest) {
    ...
    public String updateProfile(@Valid @RequestBody Map<String, Object> map, HttpServletRequest httpServletRequest) {
