...
public class CustomerController {
    ...
    @FieldFilterSetting(className = ProfileDTO.class, fields = {"company_name","company_contact","gst", "address_line", "city", "state", "country", "zip_code"})
    @GetMapping("/profile")
    public ProfileDTO viewProfile(HttpServletRequest httpServletRequest){
    ...
    public String updateProfile(@Valid @RequestBody Map<String, Object> stringObjectHashMap, HttpServletRequest httpServletRequest){
    ...
    public String updateAddress(@RequestParam("addressId") Long id, @RequestBody Map<String, Object> map, HttpServletRequest httpServletRequest){
